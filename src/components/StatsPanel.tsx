    ...
    <div className="glass-panel rounded-2xl p-6 shadow-lg border border-zinc-200/50 dark:border-zinc-800/50 space-y-4">
      ...
      <div className="space-y-2 pt-3 border-t border-zinc-200/50 dark:border-zinc-800 text-[10px] text-zinc-650 dark:text-zinc-200">
        <div className="flex justify-between items-center">
          ...
          <span className="font-mono font-bold text-zinc-800 dark:text-zinc-100">{stats.expandedNodesCount}</span>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="font-mono font-bold text-zinc-800 dark:text-zinc-100">{stats.animationDuration.toFixed(1)}s</span>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="font-mono font-bold text-zinc-800 dark:text-zinc-100">{stats.gridSize}</span>
        </div>
