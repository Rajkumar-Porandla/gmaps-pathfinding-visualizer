    ...
    <div className="glass-panel rounded-2xl p-6 shadow-lg border border-zinc-200/50 dark:border-zinc-800/50 space-y-5">
            ...
            <button
              ...
              className={`px-3 py-2 text-xs font-bold rounded-xl border text-center transition-all cursor-pointer ${
                algorithm === algo
                  ...
                  : 'bg-zinc-50 dark:bg-zinc-800 border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-800'
              }`}
            >
        ...
        <div className="grid grid-cols-2 gap-1.5">
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              className="px-2.5 py-1.5 text-xs font-bold rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 focus:outline-none cursor-pointer"
            >
      ...
      <div className="space-y-1.5">
        ...
        <select
          ...
          className="w-full px-3 py-2 text-xs font-bold rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 focus:outline-none cursor-pointer"
        >
      ...
      <div className="grid grid-cols-2 gap-1.5 border-t border-zinc-200/50 dark:border-zinc-800 pt-3">
        <button
      ...
      <div className="pt-3 border-t border-zinc-200/50 dark:border-zinc-800 space-y-2">
